...
type TransferAssetContract struct {
	...
	Amount       int64  `protobuf:"varint,4,opt,name=order,proto3" json:"order,omitempty"`
}
...
type ParticipateAssetIssueContract struct {
	...
	Amount       int64  `protobuf:"varint,4,opt,name=order,proto3" json:"order,omitempty"`                         // the order of drops
}
